...
| `frontend/src/views/Models.vue` | Model manager + HF search/collection browser/downloader; recursive model scan; platform-aware search; download queue grouped by repo. Wide-screen responsive (`.page-container` 1400px): Manager tab is a main-list (Available Models) + sidebar (Eagle-3 heads, auto-unload) on lg+ |
